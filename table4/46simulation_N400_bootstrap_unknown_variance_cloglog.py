...
def hotelling_reject(seed,n=400):
    ...
    if model2fit.message == "Optimization terminated successfully.":
        ...
        filename = path + '/dir46/' + str(seed)+'.csv'
...
if __name__ == '__main__':
    ...
    df_out.to_csv("/work/qingyang/simu_beta/46simulation_N400_bootstrap_unknown_variance_cloglog.csv",index=False)
